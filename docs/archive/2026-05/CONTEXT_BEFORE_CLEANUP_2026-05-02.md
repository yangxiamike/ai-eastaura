...
2026-05-02 更新：接下来主线正式拆成两条 plan：`docs/BUSINESS_CONTENT_PLAN_2026-05-02.md` 负责套餐、履约、获客、转化和试运营；`docs/SYSTEM_PLAN_2026-05-02.md` 负责官网、Workbench、API、通知、归因、验证和 `harness` 支撑。商业内容 plan 是主线，系统 plan 只服务主线；`harness` 不再作为主线继续扩张，只保留为 MVP 验收、运营检查和试运营数据采集的辅助底座。
...
- 2026-05-02 决策：接下来拆分为商业内容 plan 与系统 plan。商业内容 plan 是主线，锁定“套餐与履约方案”和“获客类推广”；系统 plan 是支撑线，只处理官网、Workbench、API、通知、归因、验证和 `harness` 中直接服务商业主线的事项。
- `harness` 系统降级为 P0-support：只服务 intake/lead/workbench/notification/content attribution 的验收、运营检查和试运营数据记录；不作为独立产品、平台或新 runtime 继续扩张。
...
- 按 `docs/BUSINESS_CONTENT_PLAN_2026-05-02.md` 先做 P0-1 套餐与履约方案：锁定首发城市、首批客群、5 天 4 晚套餐结构、价格假设、包含/不包含内容、合作方资源、成本测算、拒单边界、交付 SOP 和客户材料。
- 按 `docs/BUSINESS_CONTENT_PLAN_2026-05-02.md` 再做 P0-2 获客类推广：收敛官网成交文案、核心卖点、禁用表达、20 条内容选题、5 条 POV 短视频脚本、渠道节奏、UTM 归因和新 lead 24 小时跟进规则。
- 按 `docs/SYSTEM_PLAN_2026-05-02.md` 只处理会阻塞商业主线的系统事项；暂停 `harness` 新功能扩张，仅保留验收、监控和试运营记录能力。
