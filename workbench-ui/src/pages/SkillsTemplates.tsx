...
import { skillFiles } from "@/data/mock";
...
export default function SkillsTemplates() {
  ...
  return (
    <div className="space-y-5 max-w-7xl mx-auto">
      {/* Header */}
      <div>
        <h1 className="text-xl font-semibold text-eastaura-ink">Skills & Templates</h1>
        <p className="text-sm text-eastaura-ink-muted mt-0.5">
          Business knowledge files that guide AI behavior and content quality
        </p>
      </div>
